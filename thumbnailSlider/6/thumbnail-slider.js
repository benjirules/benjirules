...
function ThumbnailSlider(a) {
    ...
    let e = "length", l = document, Mb = function (c) {
            let a = c.childNodes;
            if (a && a[e]) {
                let b = a[e];
            ...
            let b = l.getElementsByTagName("head");
            if (b[e]) {
    ...
    let mb = function (b) {
        ...
        let d = "@" + o.p + "keyframes " + a + " {from{" + c + ";} to{" + f + ";}}";
        o.a.insertRule(d, 0);
