...
<head>
    ...
    <!--slider -->
    <link href="<?= ROOT_DIR ?>thumbnailSlider/5/tooltip.css" rel="stylesheet" />
    <script src="<?= ROOT_DIR ?>thumbnailSlider/5/tooltip.js"></script>
    <link href="<?= ROOT_DIR ?>thumbnailSlider/5/thumbnail-slider.css" rel="stylesheet" type="text/css" />
    <script src="<?= ROOT_DIR ?>thumbnailSlider/5/thumbnail-slider.js" type="text/javascript"></script>
