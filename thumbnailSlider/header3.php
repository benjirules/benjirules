...
<head>
    ...
    <!--slider -->
    <link href="<?= ROOT_DIR ?>thumbnailSlider/3/ninja-slider.css" rel="stylesheet" />
    <script src="<?= ROOT_DIR ?>thumbnailSlider/3/ninja-slider.js"></script>
    <link href="<?= ROOT_DIR ?>thumbnailSlider/3/thumbnail-slider.css" rel="stylesheet" type="text/css" />
    <script src="<?= ROOT_DIR ?>thumbnailSlider/3/thumbnail-slider.js" type="text/javascript"></script>
    <title></title>
</head>
<body>
<header>
