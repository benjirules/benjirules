...
<head>
    ...
    <!--slider -->
    <link href="<?= ROOT_DIR ?>thumbnailSlider/6/thumbnail-slider.css" rel="stylesheet" />
    <script src="<?= ROOT_DIR ?>thumbnailSlider/6/thumbnail-slider.js" type="text/javascript"></script>
